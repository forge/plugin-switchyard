...
public class SOAPBindServiceWizard extends AbstractSwitchYardCommand  {
...
//           targetPackage.setValue(calculateConverterPackage(project));
    ...
    {
       return Metadata.from(super.getMetadata(context), getClass()).name("Bind a Service with SOAP")
