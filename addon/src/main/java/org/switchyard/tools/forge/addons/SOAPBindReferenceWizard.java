...
public class SOAPBindReferenceWizard extends AbstractSwitchYardCommand  {
...
//           targetPackage.setValue(calculateConverterPackage(project));
    ...
    {
       return Metadata.from(super.getMetadata(context), getClass()).name("Bind a service with a SOAP reference")
