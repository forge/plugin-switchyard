...
public class HttpBindServiceWizard extends AbstractSwitchYardCommand  {
...
//           targetPackage.setValue(calculateConverterPackage(project));
    ...
    {
       return Metadata.from(super.getMetadata(context), getClass()).name("Bind a Service with HTTP")
