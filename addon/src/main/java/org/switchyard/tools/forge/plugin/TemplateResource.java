...
/**
 * Represents a template file with <code>${name}</code> tokens in it. Calls to replaceToken will change the state of the
 * content store in this object, so instances of TemplateResource should not be re-used if different values for a given
...
public class TemplateResource {
   ...
   /**
    * Write the content of this template as a Java source file. Any VAR_PACKAGE_NAME and VAR_SERVICE_NAME tokens are
    * replaced by input parameters to this method.
    * 
    ...
    */
   public String writeJavaSource(ResourcesFacet resources,
            String packageName,
            String className,
