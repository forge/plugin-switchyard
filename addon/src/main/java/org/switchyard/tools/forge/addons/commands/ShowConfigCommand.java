...
/**
 * Command class that prints the SwitchYard configuration in 
 * abbreviated or verbose (full SwitchYard XML).
 */
public class ShowConfigCommand extends AbstractSwitchYardCommand {
    
    @Inject
    @WithAttributes(label = "Verbose")
    ...
    {
       return Metadata.from(super.getMetadata(context), getClass()).name("SwitchYard: Show Config")
                .description("Show the SwitchYard Config")
    ...
    public Result execute(UIExecutionContext shellContext) throws Exception {
        ...
        String result = switchYardConfigurator.getConfig(project, verbose.getValue());
